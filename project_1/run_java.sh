...
if [ "tokenize" = $1 ]; then
	...
	java -cp jars/commons-math3-3.6.1.jar:bin/ ProbEstimator data/train_tokens.txt
elif [ "predict" = $1 ]; then
	# generate predictions
	java -cp jars/commons-math3-3.6.1.jar:bin/ Predictor data/test_tokens_fake.txt results/test_predictions.txt
